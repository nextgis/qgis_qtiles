...
class QTilesPlugin:
    ...
    def initGui(self):
        if int(self.qgsVersion) < 20000:
            ...
            QMessageBox.warning(self.iface.mainWindow(), self.tr('Error'), self.tr('QGIS %s detected.\n') % qgisVersion + self.tr('This version of QTiles requires at least QGIS 2.0. Plugin will not be enabled.'))
            return None

        self.actionRun = QAction(self.tr('QTiles'), self.iface.mainWindow())
        ...
        self.iface.addPluginToMenu(self.tr('QTiles'), self.actionRun)
        self.iface.addPluginToMenu(self.tr('QTiles'), self.actionAbout)
    ...
    def unload(self):
        ...
        self.iface.removePluginMenu(self.tr('QTiles'), self.actionRun)
        self.iface.removePluginMenu(self.tr('QTiles'), self.actionAbout)
