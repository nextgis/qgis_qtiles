...
class QTilesExceptionInfoMixin:
    """Mixin providing common fields and logic for QTiles errors and warnings."""
...
class QTilesError(QTilesExceptionInfoMixin, Exception):
    """Base exception for errors in the QTiles plugin.
    ...
    def __init__(
        ...
        *,
        ...
        :type detail: Optional[str]
        """
        QTilesExceptionInfoMixin.__init__(
            self,
            log_message,
...
class QTilesWarning(QTilesExceptionInfoMixin, UserWarning):
    """Base warning for non-critical issues in the QTiles plugin.
...
class QTilesReloadAfterUpdateWarning(QTilesWarning):
...
class QTilesUiLoadError(QTilesError):
