...
from qtiles.core.constants import PACKAGE_NAME
from qtiles.core.logging import logger, unload_logger
from qtiles.shared.qobject_metaclass import QObjectMetaClass
...
class QTilesInterface(QObject, metaclass=QObjectMetaClass):
    """Interface for the QTiles plugin.
    ...
    @classmethod
    def instance(cls) -> "QTilesInterface":
        """Return the singleton instance of the QTilesInterface plugin.

        :returns: The QTilesInterface plugin instance.
